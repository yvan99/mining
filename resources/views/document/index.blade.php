...
<!-- Mirrored from angfuzsoft.com/html/invce/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Mar 2023 15:19:33 GMT -->
                        ...
                        <header class="as-header header-layout1">
                            ...
                            <div class="header-bottom">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <div class="border-line"><img src="assets/img/bg/line_pattern.svg"
                                                alt="line"></div>
                                    </div>
                                    <div class="col-auto">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                <div class="invoice-left"><b>Terms & Conditions</b>
                                    <p class="mb-0">Authoritatively envisioneer business<br>action items through
                                        parallel sources.</p>
                                </div>
                            </div>
                            <div class="col-auto">
