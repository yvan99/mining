                  ...
                  <ul>
                          ...
                          <ul class="megaMenu-wrapper megaMenu-dropdown">
                              <li>
                                  <ul>
                                      ...
                                      <li class="has-subMenu-left">
                                          <a href="#" class="">
                                              <img src="img/svg/user-check.svg" alt="user-check"
                                                  class="svg nav-icon">
                                      ...
                                      <li>
                                          <a href="chat.html" class="">
                                              <img src="img/svg/activity.svg" alt="activity"
                                                  class="svg nav-icon">
                                  ...
                                  <ul>
                                      <li>
                                          <a href="kanban.html" class="">
                                              <img src="img/svg/columns.svg" alt="columns"
                                                  class="svg nav-icon">
                                      ...
                                      <li class="has-subMenu-left">
                                          <a href="#" class="">
                                              <img src="img/svg/repeat.svg" alt="repeat"
                                                  class="svg nav-icon">
                                      ...
                                      <li>
                                          <a href="task-app.html" class="">
                                              <img src="img/svg/clipboard.svg" alt="clipboard"
                                                  class="svg nav-icon">
                      ...
                      <li class="has-subMenu">
                          ...
                          <ul class="subMenu">
                              ...
                              <li class="has-subMenu-left">
                                  <a href="#" class="">
                                      <img src="img/svg/bar-chart-2.svg" alt="bar-chart-2"
                                          class="svg nav-icon">
